...
public class FileSystemEventFactory implements DelayedEventFactory<FileSystemEvent, Path, Kind<Path>> {

	@Value("${file.system.event.delay.ms}")
	private Integer delayTimeInMs;

	@Override
	public FileSystemEvent createEvent(Path source, Kind<Path> eventType) {
